...
to self-interaction
  ...
  ;; change the trend of the energy by r
  if breed = plants [
    set energy energy + r1
  ]
...
to reproduce-sheep  ; sheep procedure
  if count sheep < max-sheep [
    let my-partner one-of other sheep in-radius reproduce-radius
    if my-partner != nobody and random-float 1 < reproduce-chance [
      ...
      hatch 1 [rt random-float 360 fd walk set energy (energy-father + energy-mother)]
...
to reproduce-wolves  ; wolf procedure
  ...
  if count wolves < max-wolves [
    let my-partner one-of other wolves in-radius reproduce-radius
    if my-partner != nobody and random-float 1 < reproduce-chance [
      let energy-father energy / 2
      let energy-mother [energy] of my-partner / 2
      hatch 1 [rt random-float 360 fd walk set energy (energy-father + energy-mother)]
...
to flee
  ...
  ifelse nearby-wolf != nobody [
    ...
    rt random 45
    fd sprint - 0.5 ;; Move forward to escape
  ][ move ]
...
"" ""
PENS
"sheep" 1.0 0 -1184463 true "" "plot count sheep"
"wolves" 1.0 0 -16449023 true "" "plot count wolves"
"plants" 1.0 0 -10899396 true "" "plot count plants"
...
setup</setup>
  ...
  <experiment name="coexistance" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="a11">
      <value value="-0.03"/>
    </enumeratedValueSet>
    <steppedValueSet variable="reproduce-chance" first="0.05" step="0.05" last="1"/>
    <steppedValueSet variable="countdown-regrowth" first="0" step="1" last="50"/>
    <enumeratedValueSet variable="a12">
      <value value="-0.7"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-number-wolves">
      <value value="80"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a13">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-number-sheep">
      <value value="110"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a21">
      <value value="0.7"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-number-plants">
      <value value="434"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a22">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a31">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="r1">
      <value value="0.34"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a23">
      <value value="-0.4"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a32">
      <value value="0.13"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="r2">
      <value value="-0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Model-chosen">
      <value value="&quot;classic&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="r3">
      <value value="-1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="a33">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
